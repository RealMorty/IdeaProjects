        ...
        $(function () {
            $("#username").blur(function () {
                ...
                if (username == null || username === "") {
                    ...
                    $.get("isUserNameExists", {username: username}, function (data) {
...
<div class="rg_layout">
    <div class="rg_form clearfix">
        ...
        <div class="rg_form_center">
            ...
            <!--注册表单-->
            <form id="registerForm" action="${pageContext.request.contextPath}/CustomerRegisterServlet"
                  method="post">
                <!--提交处理请求的标识符-->
                ...
                <table style="margin-top: 25px;">
                    ...
                    <tr>
                        ...
                        <td class="td_right check">
                            ...
                            <span id="msg" style="color: red;font-size: 3px">${requestScope.ErrorMsg}</span>
                        </td>
                    </tr>
                </table>
            </form>
